...
### 2. Deploy our bot to Azure
  ...
  1. Now we will open PowerShell to run Bot Framework Composer scripts to deploy your bot solution to Azure.
     ...
     - Run the following command:-
        ...
        Invoke-WebRequest -Uri "https://github.com/Vaarajo/DesireToInspire/raw/master/downloads/template-with-preexisting-rg.json" -OutFile "./DeploymentTemplates/template-with-preexisting-rg.json"
